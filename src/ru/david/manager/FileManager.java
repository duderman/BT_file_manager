...
//        mPathStack.push(mPathStack.peek() + "sdcard");
     ...
     */
    public ArrayList<String> getPreviousDir(boolean withPrefix) {
     ...
     * @return
     */
    public ArrayList<String> getNextDir(String path, boolean isFullPath, boolean withPrefix) {
        int size = mPathStack.size();
    ...
    public ArrayList<String> getNextDir(String path, boolean isFullPath) {
        return getNextDir(path, isFullPath, false);
    }
     ...
     * @return
     */
    private ArrayList<String> populate_list(boolean withPrefix) {
            ...
            if (mDirContent.size() == 1 && mDirContent.get(0) == "Empty") {
                ...
                for (String fileStr : mDirContent) {
                    if (new File(current + "/" + fileStr).isDirectory())
                        resultArray.add("D_" + fileStr);
                    else
                        resultArray.add("F_" + fileStr);
                }
            return resultArray;
        } else
            return mDirContent;
